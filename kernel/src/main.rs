...
#[cfg(any(
    ...
    all(feature = "qemu-test-user-entry", feature = "qemu-test-user-trap")
))]
...
pub extern "C" fn kernel_main(hart_id: usize, dtb: usize) -> ! {
    ...
    #[cfg(any(feature = "qemu-test-user-entry", feature = "qemu-test-user-trap"))]
    {
